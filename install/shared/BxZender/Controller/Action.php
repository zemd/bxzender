...
require_once 'BxZender/Controller/Action/Interface.php';
require_once 'BxZender/Controller/Bitrix.php';
require_once 'BxZender/View.php';


global $view;
$view = null;

abstract class BxZender_Controller_Action implements BxZender_Controller_Action_Interface
{
    /**
    ...
    /**
     * View script suffix; defaults to 'php'
     * @see {render()}
     * @var string
     */
     ...
     * @return void
     */
    public function __construct(BxZender_Controller_Request_AbstractRequest $request, Zend_Controller_Response_Abstract $response, array $invokeArgs = array())
    {
        $this->setRequest($request)
             ->setResponse($response)
             ->_setInvokeArgs($invokeArgs);
        //$this->_helper = new BxZender_Controller_Action_HelperBroker($this);
        $this->init();
        $this->initView();
    }
...
//        );
     ...
     * @return Zend_Controller_Action
     */
    public function setFrontController(BxZender_Controller_Bitrix $front)
    {
     ...
     * @return Zend_Controller_Response_Abstract
     */
    public function run(BxZender_Controller_Request_AbstractRequest $request = null, Zend_Controller_Response_Abstract $response = null)
    {
        if (null !== $request) {
            $this->setRequest($request);
        } else {
