<?php
require_once 'BxZender/Controller/Dispatcher/Interface.php';

abstract class BxZender_Controller_Dispatcher_AbstractDispatcher implements BxZender_Controller_Dispatcher_Interface
{
    /**
     * Default action
     * @var string
     ...
     * @var BxZender_Controller_Bitrix
     */
    protected $_bitrixController;
...
//         preserve directories
    ...
    {
        if (null === $this->_bitrixController) {
            require_once 'BxZender/Controller/Bitrix.php';
            $this->_bitrixController = BxZender_Controller_Bitrix::getInstance();
        }

        return $this->_bitrixController;
    }
     ...
     * @return Zend_Controller_Dispatcher_Abstract
     */
    public function setBitrixController(BxZender_Controller_Bitrix $controller)
    {
        $this->_bitrixController = $controller;
        return $this;
    }
